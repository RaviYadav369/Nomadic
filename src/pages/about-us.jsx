...
const AboutUs = ({ className = "" }) => {
  return (
    <div
      className={`w-full h-full text-gainsboro-100 bg-gray-200 max-w-full overflow-hidden flex flex-col items-end justify-start pt-8 px-0  box-border relative gap-[68px] leading-[normal] tracking-[normal] mq800:gap-[34px] mq450:h-auto mq450:gap-[17px] ${className}`}
    >
      <img
        ...
        <div className="flex-1 rounded-lg overflow-hidden flex flex-row items-start justify-between p-16 box-border relative bg-[url('/public/section-2--product-features@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full gap-[20px] mq800:pl-8 mq800:pr-8 mq800:box-border mq450:pt-[42px] mq450:pb-[42px] mq450:box-border mq1350:flex-wrap">
          <div className="w-[535px] flex flex-col items-start justify-start pt-1 px-0 pb-0 box-border min-w-[535px] max-w-full mq800:min-w-full mq1350:flex-1">
            <div className="self-stretch flex flex-col items-start justify-start gap-[24px]">
              ...
              <button className="cursor-pointer text-gainsboro-100 py-3.5 px-[25px] bg-[transparent] rounded-lg flex flex-row items-center justify-center whitespace-nowrap border-[1px] border-solid border-aliceblue hover:bg-lightgray-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-lightgray-200">
                <div className="relative text-lg capitalize font-medium font-montserrat text-black-white-gray10 text-center">
                  Visit Shop Page
                </div>
              </button>
            </div>
